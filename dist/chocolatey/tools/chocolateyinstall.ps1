...
if ($is_arm64) {
    $url      = 'https://github.com/paulo-amaral/easyscp/releases/download/v1.1.1/easyscp-v1.1.1-msvc.zip'
    $checksum = 'f6ad6c62f1578562f9af4bcee93bd4cc429cb52219c3636359b008db8789587e'
} else {
    $url      = 'https://github.com/paulo-amaral/easyscp/releases/download/v1.1.1/easyscp-v1.1.1-x86_64-pc-windows-msvc.zip'
