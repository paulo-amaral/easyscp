#!/usr/bin/env bash
# Bump easyscp version across all tracked locations.
...
sedi "s/^EASYSCP_VERSION=\"[0-9][0-9A-Za-z.\\-]*\"/EASYSCP_VERSION=\"$VERSION\"/m" "$ROOT/install.sh"
...
sedi "s#releases/download/v[0-9][0-9A-Za-z.\\-]*/easyscp-v[0-9][0-9A-Za-z.\\-]*-#releases/download/v$VERSION/easyscp-v$VERSION-#g" "$ROOT/dist/chocolatey/tools/chocolateyinstall.ps1"
