...
easyscp lets you save your favourite hosts as bookmarks, which can then be loaded quickly from the main layout. easyscp also keeps the last 16 hosts you connected to. Both features let you reload all the parameters required to connect to a remote simply by selecting an entry in the tab under the authentication form.
