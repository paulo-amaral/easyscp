    ...
    pub fn new(color: Color) -> Self {
        Self {
            component: Paragraph::default()
                ...
                .foreground(color)
                .text(Text::from_iter([SpanStatic::from(
                    "easyscp requires at least 24 lines of height to run",
                )]))
                .wrap_trim(true),
        }
    }
    ...
    pub fn new(color: Color) -> Self {
        Self {
            component: Radio::default()
                ...
                .title(Title::from("Quit easyscp?").alignment(HorizontalAlignment::Center))
                .rewind(true)
                .choices(["Yes", "No"]),
        }
    }
            ...
            component: List::default()
                ...
                .rows(
                    TableBuilder::default()
                        ...
                        .add_col(SpanStatic::from("           Quit easyscp"))
                        .add_row()
